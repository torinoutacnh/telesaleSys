...
using Entity = Invedia.Data.EF.Models.Entity;
    ...
    public class UnitOfWork : BaseEntityUnitOfWork, IUnitOfWork
    {
        ...
        protected override void StandardizeEntities()
        {
            ...
            foreach (var entry in listEntry)
            {
                ...
                //        entity.LastUpdatedTime = entity.CreatedTime = dateTimeNow;
                //    }
                //    else
                //    {
                //        if (entity.DeletedTime != null)
                //            entity.DeletedTime =
                //                ObjHelper.ReplaceNullOrDefault(entity.DeletedTime, dateTimeNow);
                //        else
