...
namespace XProject.Repository.Migrations
{
    ...
    [Migration("20220405121318_update3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.WorkingDaily", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.WorkingTime", b =>
                {
                    ...
                    b.Property<string>("WorkingDailyId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("WorkingDailyId");
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.WorkingTime", b =>
                {
                    b.HasOne("XProject.Contract.Repository.Models.WorkingDaily", "WorkingDaily")
                        .WithMany("Working_Times")
                        .HasForeignKey("WorkingDailyId");

                    b.Navigation("WorkingDaily");
                });
