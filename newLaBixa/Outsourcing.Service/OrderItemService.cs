...
namespace Outsourcing.Service
{
    public interface IOrderItemService
    {
        ...
        IEnumerable<OrderItem> GetOrderItemsByLogId(int logDiaryId);
    ...
    public class OrderItemService : IOrderItemService
    {
        ...
        public IEnumerable<OrderItem> GetOrderItemsByLogId(int logDiaryId)
        {
            var orderItems = orderItemRepository.GetAll().Where(i => i.LogdiaryId == logDiaryId);
            return orderItems;
        }
